 ...
 */
export function logUsage(provider, usage, model = null, connectionId = null, apiKey = null, detailId = null) {
  ...
  saveRequestUsage({ model, provider, connectionId, tokens, apiKey: apiKey || undefined, detailId: detailId || undefined }).catch(() => { });
